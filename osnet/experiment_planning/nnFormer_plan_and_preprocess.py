...
from osnet.experiment_planning.utils import crop
from osnet.paths import *
import shutil
from osnet.utilities.task_name_id_conversion import convert_id_to_task_name
from osnet.preprocessing.sanity_checks import verify_dataset_integrity
...
def main():
    ...
    search_in = join(osnet.__path__[0], "experiment_planning")
