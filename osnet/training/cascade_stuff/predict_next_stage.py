...
import argparse
from osnet.preprocessing.preprocessing import resample_data_or_seg
from batchgenerators.utilities.file_and_folder_operations import maybe_mkdir_p
import osnet
from osnet.run.default_configuration import get_default_configuration
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(osnet.__path__[0], "training", "network_training")],
                                                trainerclass,
