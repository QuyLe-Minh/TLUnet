...
from tlunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from tlunet.training.loss_functions.dice_loss import DC_and_CE_loss
from tlunet.training.network_training.network_trainer_synapse import NetworkTrainer_synapse
...
class Trainer_synapse(NetworkTrainer_synapse):
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(tlunet.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="tlunet.preprocessing")
