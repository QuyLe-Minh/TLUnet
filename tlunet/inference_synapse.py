...
def test(fold): 
    label_path= "DATASET_Synapse/unetr_pp_raw/unetr_pp_raw_data/Task002_Synapse" # Replace None by full path of "DATASET/unetr_pp_raw/unetr_pp_raw_data/Task002_Synapse/"
