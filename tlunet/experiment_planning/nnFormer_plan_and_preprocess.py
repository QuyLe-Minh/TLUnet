...
from tlunet.experiment_planning.utils import crop
from tlunet.paths import *
import shutil
from tlunet.utilities.task_name_id_conversion import convert_id_to_task_name
from tlunet.preprocessing.sanity_checks import verify_dataset_integrity
...
def main():
    ...
    search_in = join(tlunet.__path__[0], "experiment_planning")
